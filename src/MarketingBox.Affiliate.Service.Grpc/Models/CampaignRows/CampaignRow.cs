...
namespace MarketingBox.Affiliate.Service.Grpc.Models.CampaignRows
{
    ...
    public class CampaignRow
    {
        ...
        [DataMember(Order = 4)] public int Priority { get; set; }
        [DataMember(Order = 5)] public int Weight { get; set; } 
        [DataMember(Order = 6)] public CapType CapType { get; set; }
        [DataMember(Order = 7)] public long DailyCapValue { get; set; }
        ...
        [DataMember(Order = 11)] public int? GeoId { get; set; }
        [DataMember(Order = 12)] public string GeoName { get; set; }
    }
}