...
namespace MarketingBox.Affiliate.Service
{
    ...
    {
        public const string SettingsFileName = ".marketingboxaffiliateservice";
        ...
        {
            Console.Title = "MarketingBox.Affiliate.Service";

            Settings = SettingsReader.GetSettings<SettingsModel>(SettingsFileName);

            using var loggerFactory = LogConfigurator.ConfigureElk_v2("MarketingBox.Affiliate.Service",
