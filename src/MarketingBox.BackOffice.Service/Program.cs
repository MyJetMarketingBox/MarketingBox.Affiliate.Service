...
using MarketingBox.BackOffice.Service.Settings;
...
namespace MarketingBox.BackOffice.Service
{
    public class Program
    {
        ...
        {
            Console.Title = "MarketingBox.BackOffice.Service";

            Settings = SettingsReader.GetSettings<SettingsModel>(SettingsFileName);

            //TODO: Switch to marketbox
